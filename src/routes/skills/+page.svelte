			...
			<table class="table-auto border-separate border-spacing-y-4">
				...
				<tbody class="align-text-top leading-relaxed">
					...
					<tr>
						...
						<td class="font-light align-text-top">HTML, CSS, Sass, JavaScript, TypeScript, SQL, ReactJS, Laravel, Django, Java, Java Spring Boot, Celery, Redis, MySQL, Dbeaver, DataGrip</td>
					</tr>
					<tr>
